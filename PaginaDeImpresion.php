...
<body>
   ...
   <div class="TerminosYCondiciones">
        <div class="TC1">        
            ...
            <div>
                <p>2. IDENTIFICACIÓN DEL RESPONSABLE DE TRATAMIENTO
                El responsable de tratamiento de datos vinculados con el servicio que ofrece es SAMUEL ENRIQUE GONZALEZ SANCHEZ, con domicilio en la ciudad de Caracas, Municipio Libertador, Parroquia El Recreo, con número de Cedula de Identidad V-19.933.272.  En lo sucesivo EL RESPONSABLE.</p>
            </div>
    
            <div>
                <p>3. CONDICIONES DEL SERVICIO
                SOLUCIONES Y PRODUCCIONES CREACTIVA, C.A., es una empresa informática, que brinda elaboración de sistemas computarizados con soporte técnico y con especial énfasis en la publicidad web corporativa.  “LA EMPRESA”, desarrolla proyectos audiovisuales de alta calidad contando con equipos multidisciplinarios que brindan diseño grafico, edición de videos, apegados a los más altos estándares de calidad y apegados al marco Legal internacional.</p>
            </div>
        ...
        <div class="TC2">
            ...
            <div>
                <p>“LA EMPRESA” brindará el “SERVICIO” una vez que el “CLIENTE” acepte las CONDICIONES GENERALES” y de acuerdo al requerimiento contratado por el “CLIENTE” en las “CONDICIONES PARTICULARES”, y el “CONTRATO DE TRATAMIENTO”.  Para lo cual “EL CLIENTE” realizará por adelantado el pago con base a las condiciones y/o facilidades seleccionadas en el presupuesto, conforme al plan deberá sumársele el importe correspondiente al Impuesto al Valor Agregado IVA.</p>
            </div>
            <div>
            ...
            <div>
                <p>El pago se podrá realizar mediante transferencia bancaria a la cuenta bancaria designada por el RESPONSABLE, o mediante pago por tarjeta de crédito a través del sistema virtual facilitado a tal efecto.</p>
            </div>
            <div>
