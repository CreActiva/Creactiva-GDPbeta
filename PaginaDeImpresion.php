...
?>
    ...
    <content>
        ...
        <?php for($i=0;$i<$ContD;$i++) {
        echo '<div id="DC" class="'.$i.'"><div id="S"></div><div id="NDT"><div id="C"><h2><span class="N">Nombre: </span>'.$NombreDatoTrabajo[$i].'</h2></div></div><div id="DT"><div id="C"><h2>'.$DatoTrabajo[$i].'</h2></div></div><div id="S"></div></div>';}?>
    </content>
    <!--
