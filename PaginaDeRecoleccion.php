...
<body>
    ...
    --->
            ...
            --->
                    ...
                    <div id="DatosTabla">
                        <div class="from-group mt-4">
                            <h3>Nombre del dato y desarrollo de descripción de dato realizado</h3>
                            <!--
                ...
                --->
                            ...
                            <!--MAQUETACION DE IDEA-->
                            <textarea id="delNDT2" class="d-none" name="NDT2"></textarea>
                            <textarea id="delNDT3" class="d-none" name="NDT3"></textarea>
                            <textarea id="delNDT4" class="d-none" name="NDT4"></textarea>
                            <textarea id="delNDT5" class="d-none" name="NDT5"></textarea>
                            <textarea maxlength="550" type="text" class="form-control mb-3" placeholder="Descripción1" Name="DT1" id="DT1" required></textarea>
                            <!--MAQUETACION DE IDEA-->
                            <textarea id="delDT2" class="d-none" name="DT2"></textarea>
                            <textarea id="delDT3" class="d-none" name="DT3"></textarea>
                            <textarea id="delDT4" class="d-none" name="DT4"></textarea>
                            <textarea id="delDT5" class="d-none" name="DT5"></textarea>
